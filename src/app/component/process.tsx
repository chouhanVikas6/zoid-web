export default function ProcesSection(){
    return  <section className="flex flex-col min-h-[600px] py-16 bg-gradient-to-b from-gray-900 to-gray-800 relative">
        <div className="w-full max-w-6xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-center text-white drop-shadow-lg">Our Process</h1>
          <p className="text-lg md:text-xl text-gray-200 mb-12 text-center max-w-2xl mx-auto">
            We follow a rigorous process to ensure the highest quality in our solutions.
          </p>
          <div className="flex gap-8 px-4 md:px-0 snap-x snap-mandatory justify-center">
            {/* Step 1 */}
            <div className="min-w-[320px] max-w-xs bg-white/90 rounded-2xl shadow-xl p-8 flex flex-col items-center snap-center border border-gray-200 hover:scale-105 transition-transform duration-300">
